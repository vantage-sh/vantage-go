...
type ClientService interface {
	GetReportResources(params *GetReportResourcesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReportResourcesOK, error)
...
func (a *Client) GetReportResources(params *GetReportResourcesParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetReportResourcesOK, error) {
	...
	if params == nil {
		params = NewGetReportResourcesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getReportResources",
		Method:             "GET",
		...
		Params:             params,
		Reader:             &GetReportResourcesReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetReportResourcesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getReportResources: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) GetResource(params *GetResourceParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetResourceOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "getResource",
		Method:             "GET",
		PathPattern:        "/resources/{resource_token}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
