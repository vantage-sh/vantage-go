...
// WithLimit adds the limit to the get team members params
func (o *GetTeamMembersParams) WithLimit(limit *int32) *GetTeamMembersParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get team members params
func (o *GetTeamMembersParams) SetLimit(limit *int32) {
	o.Limit = limit
}

// WithPage adds the page to the get team members params
func (o *GetTeamMembersParams) WithPage(page *int32) *GetTeamMembersParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get team members params
func (o *GetTeamMembersParams) SetPage(page *int32) {
	o.Page = page
}

// WithTeamToken adds the teamToken to the get team members params
func (o *GetTeamMembersParams) WithTeamToken(teamToken string) *GetTeamMembersParams {
	o.SetTeamToken(teamToken)
	return o
}

// SetTeamToken adds the teamToken to the get team members params
func (o *GetTeamMembersParams) SetTeamToken(teamToken string) {
