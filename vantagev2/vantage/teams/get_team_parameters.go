...
// WithTeamToken adds the teamToken to the get team params
func (o *GetTeamParams) WithTeamToken(teamToken string) *GetTeamParams {
	o.SetTeamToken(teamToken)
	return o
}

// SetTeamToken adds the teamToken to the get team params
func (o *GetTeamParams) SetTeamToken(teamToken string) {
