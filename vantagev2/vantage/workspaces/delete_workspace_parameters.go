...
// WithWorkspaceToken adds the workspaceToken to the delete workspace params
func (o *DeleteWorkspaceParams) WithWorkspaceToken(workspaceToken string) *DeleteWorkspaceParams {
	o.SetWorkspaceToken(workspaceToken)
	return o
}

// SetWorkspaceToken adds the workspaceToken to the delete workspace params
func (o *DeleteWorkspaceParams) SetWorkspaceToken(workspaceToken string) {
