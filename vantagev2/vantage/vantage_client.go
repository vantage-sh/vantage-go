...
import (
	...
	"github.com/vantage-sh/vantage-go/vantagev2/vantage/access_policies"
	...
	"github.com/vantage-sh/vantage-go/vantagev2/vantage/canvases"
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Vantage {
	...
	cli.Canvases = canvases.New(transport, formats)
...
type Vantage struct {
	...
	AccessPolicies access_policies.ClientService
	...
	Canvases canvases.ClientService
...
func (c *Vantage) SetTransport(transport runtime.ClientTransport) {
	...
	c.Canvases.SetTransport(transport)
