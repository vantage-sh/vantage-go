...
type ClientService interface {
	...
	CreateKubernetesEfficiencyReportExport(params *CreateKubernetesEfficiencyReportExportParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateKubernetesEfficiencyReportExportAccepted, error)
	...
	GetKubernetesEfficiencyReportCosts(params *GetKubernetesEfficiencyReportCostsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetKubernetesEfficiencyReportCostsOK, error)
...
/*
CreateKubernetesEfficiencyReportExport generates kubernetes efficiency data export

Generate a DataExport of Kubernetes efficiency data.
*/
func (a *Client) CreateKubernetesEfficiencyReportExport(params *CreateKubernetesEfficiencyReportExportParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateKubernetesEfficiencyReportExportAccepted, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateKubernetesEfficiencyReportExportParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "createKubernetesEfficiencyReportExport",
		Method:             "POST",
		PathPattern:        "/kubernetes_efficiency_reports/data_exports",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &CreateKubernetesEfficiencyReportExportReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*CreateKubernetesEfficiencyReportExportAccepted)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for createKubernetesEfficiencyReportExport: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetKubernetesEfficiencyReportCosts gets costs for kubernetes efficiency report

Return costs for a KubernetesEfficiencyReport.
*/
func (a *Client) GetKubernetesEfficiencyReportCosts(params *GetKubernetesEfficiencyReportCostsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetKubernetesEfficiencyReportCostsOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetKubernetesEfficiencyReportCostsParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getKubernetesEfficiencyReportCosts",
		Method:             "GET",
		PathPattern:        "/kubernetes_efficiency_reports/{kubernetes_efficiency_report_token}/costs",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetKubernetesEfficiencyReportCostsReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*GetKubernetesEfficiencyReportCostsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getKubernetesEfficiencyReportCosts: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
