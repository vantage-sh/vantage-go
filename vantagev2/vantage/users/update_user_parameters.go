...
// WithUserToken adds the userToken to the update user params
func (o *UpdateUserParams) WithUserToken(userToken string) *UpdateUserParams {
	o.SetUserToken(userToken)
	return o
}

// SetUserToken adds the userToken to the update user params
func (o *UpdateUserParams) SetUserToken(userToken string) {
