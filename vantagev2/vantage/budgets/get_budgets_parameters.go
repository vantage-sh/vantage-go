...
type GetBudgetsParams struct {
	...
	*/
	...
	/* WorkspaceToken.
	   ...
	   The workspace token of the budgets to return.
	*/
...
// WithQ adds the q to the get budgets params
func (o *GetBudgetsParams) WithQ(q *string) *GetBudgetsParams {
	o.SetQ(q)
	return o
}

// SetQ adds the q to the get budgets params
func (o *GetBudgetsParams) SetQ(q *string) {
	o.Q = q
}

// WithWorkspaceToken adds the workspaceToken to the get budgets params
func (o *GetBudgetsParams) WithWorkspaceToken(workspaceToken *string) *GetBudgetsParams {
	o.SetWorkspaceToken(workspaceToken)
	return o
}

// SetWorkspaceToken adds the workspaceToken to the get budgets params
func (o *GetBudgetsParams) SetWorkspaceToken(workspaceToken *string) {
