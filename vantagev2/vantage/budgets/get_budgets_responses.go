...
func (o *GetBudgetsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /budgets] getBudgets", response, response.Code())
	}
}
...
func (o *GetBudgetsOK) Error() string {
	...
	return fmt.Sprintf("[GET /budgets][%d] getBudgetsOK %s", 200, payload)
}
