...
func (o *GetIntegrationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /integrations] getIntegrations", response, response.Code())
	}
}
...
func (o *GetIntegrationsOK) Error() string {
	return fmt.Sprintf("[GET /integrations][%d] getIntegrationsOK  %+v", 200, o.Payload)
}
