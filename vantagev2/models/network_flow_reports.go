...
func (m *NetworkFlowReports) validateLinks(formats strfmt.Registry) error {
...
func (m *NetworkFlowReports) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
