...
func (m *TeamMembers) validateLinks(formats strfmt.Registry) error {
...
func (m *TeamMembers) validateMembers(formats strfmt.Registry) error {
...
func (m *TeamMembers) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
...
func (m *TeamMembers) contextValidateMembers(ctx context.Context, formats strfmt.Registry) error {
