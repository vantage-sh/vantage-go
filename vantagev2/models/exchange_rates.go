...
func (m *ExchangeRates) validateLinks(formats strfmt.Registry) error {
...
func (m *ExchangeRates) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
