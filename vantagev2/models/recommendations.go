...
func (m *Recommendations) validateLinks(formats strfmt.Registry) error {
...
func (m *Recommendations) contextValidateLinks(ctx context.Context, formats strfmt.Registry) error {
