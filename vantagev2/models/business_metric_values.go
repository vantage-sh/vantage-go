...
// Validate validates this business metric values
func (m *BusinessMetricValues) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BusinessMetricValues) validateValues(formats strfmt.Registry) error {
...
func (m *BusinessMetricValues) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BusinessMetricValues) contextValidateValues(ctx context.Context, formats strfmt.Registry) error {
