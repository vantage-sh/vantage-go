...
type CreateFinancialCommitmentReport struct {
	...
	// Grouping values for aggregating costs on the FinancialCommitmentReport. Valid groupings: cost_type, commitment_type, commitment_id, service, resource_account_id, provider_account_id, region, cost_category, cost_sub_category, instance_type, tag:<label_name>.
...
const (
	...
	// CreateFinancialCommitmentReportDateBucketHour captures enum value "hour"
	CreateFinancialCommitmentReportDateBucketHour string = "hour"
	...
	// CreateFinancialCommitmentReportDateBucketQuarter captures enum value "quarter"
	CreateFinancialCommitmentReportDateBucketQuarter string = "quarter"
)
...
const (
	...
	// CreateFinancialCommitmentReportDateIntervalLast14Days captures enum value "last_14_days"
	CreateFinancialCommitmentReportDateIntervalLast14Days string = "last_14_days"
)
