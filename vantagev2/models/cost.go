...
const (
	...
	// CostProviderRedisCloud captures enum value "redis_cloud"
	CostProviderRedisCloud string = "redis_cloud"
	...
	// CostProviderDeepgram captures enum value "deepgram"
	CostProviderDeepgram string = "deepgram"
)
